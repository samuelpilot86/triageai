...
export default function ReportPanel({ result }: { result: AnalysisResult }) {
  const { items, corrections: rawCorrections, report, used_fallback, report_fallback } = result;
  // Safety filter: only show genuine corrections where the value actually changed
